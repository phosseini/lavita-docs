...
- **`qa_main.log`**  
  This file contains logs for every step of running AI Jobs. You can check this file line by line to see what actually happens when your jobs are running. In case of failure, reviewing this file provides insights into where the issue might be.
