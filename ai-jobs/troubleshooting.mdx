...
- **`qa_progress.log`**  
  This file captures system logs, including  
  [`stdout`](https://en.wikipedia.org/wiki/Standard_streams) and  
  [`stderr`](https://en.wikipedia.org/wiki/Standard_streams).  
  It helps display the progress of AI Jobs on the Edge Node UI while also catching error messages or diagnostics.
