...
<AccordionGroup>
  ...
  <Accordion title="How does LAVITA Cross Chain Transfer work?" icon="alien-8bit">
    ...
    <Frame>
      <img src="/images/faq-token-transfer-1.png" style="width: 100%;" />
    </Frame>
    ...
    <Frame>
      <img src="/images/faq-token-transfer-2.png" style="width: 100%;" />
    </Frame>

    Once you've completed this, go to Lavita Mainnet.

    <Frame>
      <img src="/images/faq-token-transfer-3.png" style="width: auto; max-width: 100%; height: 150px; object-fit: cover;" />
    </Frame>

    <Frame>
      <img src="/images/faq-token-transfer-4.png" style="width: auto; max-width: 100%; height: 150px; object-fit: cover;" />
    </Frame>
