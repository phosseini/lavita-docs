...
<Note>
🚀 Check out the new [Medical Sphere](https://sphere.lavita.ai) — join our community for evaluating AI models in healthcare!
</Note>

<Tip>
🚀 Check out the [Lavita 2025 Development Roadmap](https://lavita-ai.medium.com/lavita-2025-development-roadmap-353e6ef2c88f) on our blog!
</Tip>
...
<CardGroup cols={2}>
  <Card title="Medical Sphere" icon="sparkles" href="https://docs.lavita.ai/medical-sphere/introduction" />
